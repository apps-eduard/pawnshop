  ...
  template: `
    <div class="space-y-3">
      ...
      >
        ...
        <div class="p-3">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            <div>
              <label class="block text-xs font-small text-gray-700 dark:text-gray-300 mb-1"
                >Contact Number</label
              >
              <input
                type="text"
                [(ngModel)]="customerInfo.contactNumber"
            ...
            <div>
              ...
              <input
                type="text"
                [(ngModel)]="customerInfo.completeAddress"
                class="w-full px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                readonly
              />
            </div>
      ...
      >
        ...
        <div class="p-2">
          <div class="flex flex-wrap lg:flex-nowrap justify-between gap-1.5">
            <div class="flex-1 min-w-[95px]">
              <label class="block text-xs font-small text-gray-700 dark:text-gray-300 mb-1"
                >Transaction Date</label
              >
              <input
                type="date"
                [(ngModel)]="transactionInfo.transactionDate"
                class="w-full px-1.5 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                readonly
              />
            </div>
            <div class="flex-1 min-w-[100px]">
              ...
              <input
                type="date"
                [(ngModel)]="transactionInfo.grantedDate"
                class="w-full px-1.5 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                readonly
              />
            </div>
            <div class="flex-1 min-w-[100px]">
              ...
              <input
                type="date"
                [(ngModel)]="transactionInfo.maturedDate"
                class="w-full px-1.5 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                readonly
              />
            </div>
            <div class="flex-1 min-w-[110px]">
              <label class="block text-xs font-small text-green-700 dark:text-green-400 mb-1"
                >Redeem Date</label
              >
              <input
                type="date"
                [(ngModel)]="transactionInfo.gracePeriodDate"
                class="w-full px-1.5 py-1 text-xs border-2 border-green-400 dark:border-green-500 rounded focus:outline-none focus:ring-2 focus:ring-green-500 bg-green-50 dark:bg-green-900/20 text-green-900 dark:text-green-300 font-semibold"
                readonly
              />
            </div>
            <div class="flex-1 min-w-[100px]">
              ...
              <input
                type="date"
                [(ngModel)]="transactionInfo.expiredDate"
                class="w-full px-1.5 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                readonly
              />
            </div>
            <div class="flex-1 min-w-[80px]">
              ...
              <div class="flex items-center h-[29px]">
                <span
                  [ngClass]="getLoanStatusClass()"
                  class="px-2 py-1 rounded-full text-xs font-medium w-full text-center"
                >
                  {{ getLoanStatus() }}
                </span>
              </div>
            ...
            <div class="flex-1 min-w-[100px]">
              <label class="block text-xs font-small text-gray-700 dark:text-gray-300 mb-1"
                >Duration</label
              >
              <div class="flex items-center gap-0.5 h-[29px]" [ngClass]="getDurationAnimationClass()">
                <div
                  class="flex items-center bg-gradient-to-r text-white px-1 py-0.5 rounded shadow-sm"
            ...
            <table class="w-full text-sm">
              <thead>
                <tr class="border-b border-gray-200 dark:border-gray-700">
                  <th class="text-left py-2 px-2 font-small text-gray-700 dark:text-gray-300">
                    Category
                  </th>
                  <th class="text-left py-2 px-2 font-small text-gray-700 dark:text-gray-300">
                    Description
                  ...
                  <th class="text-right py-2 px-2 font-small text-gray-700 dark:text-gray-300">
                    Appraisal Value
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr
                  *ngFor="let item of pawnedItems; let i = index"
                ...
                >
                  ...
                  <td class="py-2 px-2 text-gray-600 dark:text-gray-400">
                    {{ item.descriptionName || item.description || item.itemDescription || '-' }}
                  </td>
                  <td class="py-2 px-2 text-gray-600 dark:text-gray-400 max-w-xs">
                    {{ item.appraisalNotes || 'No remarks' }}
                  </td>
