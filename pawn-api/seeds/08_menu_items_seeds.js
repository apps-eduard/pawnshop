...
exports.seed = async function(knex) {
  ...
  console.log('✅ Created Management children: User, Pawner, Address, Item, Vouchers');
  ...
  console.log('✅ Created standalone menus: Reports, RBAC, Menu Config');
  ...
  const managementPermissions = [3, 4, 17, 5, 16].map(menuId => ({
    role_id: adminRole.id,
    menu_item_id: menuId,
    can_view: true,
    can_create: true,
  ...
  // Assign permissions for standalone menus (Reports, RBAC, Menu Config)
